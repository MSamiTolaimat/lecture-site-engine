...
- ✅ **MCQ options عربي فقط:** استخدم أ، ب، ج، د (ما تستخدم a، b، c، d)
...
**⚠️ CRITICAL RULES:**
- ✅ **خيارات واضحة ومختلفة** — ليست ترجمات مختلفة للفكرة نفسها
- ✅ **كل خيار خطأ له تعليل واضح** — ليس "هذا غلط بس" بدون شرح
- ✅ **الإجابة الصحيحة لها تعليل قوي** — من المحاضرة ومن أمثلة عملية
- ✅ **حروف عربي فقط:** أ، ب، ج، د (ما تستخدم a, b, c, d)
- ❌ **ما تستخدم ترجمة حرفية** للخيارات — استخدم تعاريف واضحة
