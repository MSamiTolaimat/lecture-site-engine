...
## 📚 استراتيجية الأمثلة (Examples Strategy) — اختياري وذكي

**الفكرة:** بعد شرح 2-3 مواضيع مترابطة، أضف مثال واحد يجمعها كلها.
**الفائدة:** يرى الطالب كيف تعمل المفاهيم معاً في الواقع.
...
#### 🎮 السيناريو (Game Dev Example)
[مثال فعلي من تطوير اللعبة أو نظام حقيقي]
...
| --- | --- | --- | --- |
| **Indie** | لعبة صغيرة (1-3 أشخاص) | منخفضة | Agile، سرعة |
| **Mid-size** | لعبة متوسطة (10-20) | متوسطة | Iterative |
| **AAA** | لعبة كبيرة (100+) | عالية | Spiral |
...
- [ ] الملخص (Part 1): ماذا ستتعلم + لماذا مهم + المتطلبات
...
**السيناريو 1: لعبة Indie صغيرة**
- المتطلبات: غير واضحة (تطورت مع التطوير)
- الفريق: صغير، رشيق
- **النموذج:** Agile أو Iterative
- **السبب:** سرعة التطور مهمة أكتر من التخطيط الكامل

**السيناريو 2: لعبة AAA كبيرة (مثل Call of Duty)**
- المتطلبات: معرفة مسبقة، لكن تتطور
- الفريق: كبير، مقسم (Graphics, AI, Physics)
- **النموذج:** Spiral أو Iterative
- **السبب:** محاذير تقنية عالية، لكن تحتاج flexibility

**السيناريو 3: نظام بنكي**
- المتطلبات: واضحة جداً (compliance + security)
- الفريق: كبير، structured
- **النموذج:** Waterfall
- **السبب:** أي خطأ = فلوس تضيع، قانون ينتهك

**السيناريو 4: تطبيق جوال لشركة Startup**
- المتطلبات: غير واضحة، متغيرة يومياً
- الفريق: صغير، متعدد المواهب
- **النموذج:** Agile
- **السبب:** Speed to market أهم من perfection
...
(الإجابة: Agile أو Iterative — لأن flexibility مهمة أكتر من التخطيط المسبق)
