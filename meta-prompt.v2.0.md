...
جداول + خطوات وإجراءات + أنماط:
- **تعريفات:** جدول المصطلح | التعريف
- **مكونات:** جدول المكون | الشرح
- **مقارنات:** جدول معايير المقارنة
- **مصطلحات (Glossary):** الإنجليزية | العربية | الشرح
- **نقاط ذهبية:** قائمة مرقّمة
- **أخطاء شائعة:** ❌ خطأ | ✅ صواب
