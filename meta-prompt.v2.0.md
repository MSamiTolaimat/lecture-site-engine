...
**الغرض:** تفهم ماذا ستتعلم، ليه مهم، إيش المتطلبات السابقة، وإيش الأخطاء الشائعة.

**المحتوى:**
- 📍 عن هذه المحاضرة (جملة واحدة)
- 🎯 ستتعلم (3-4 مفاهيم بشرح قصير)
- 📚 المتطلبات السابقة (مرتبطة بمحاضرات سابقة)
- 💡 الأفكار الرئيسية (لماذا مهمة + كيف تُستخدم)
- 🔗 الربط مع محاضرات أخرى
- ⚠️ أخطاء شائعة واجب تجنبها

**لا تضع:** جداول مقارنات أو تعاريف طويلة (تلك في Cheat Sheet)
